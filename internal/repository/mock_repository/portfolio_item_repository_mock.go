...
//go:generate minimock -i gitlab.ozon.dev/zBlur/homework-2/internal/repository.PortfolioItemRepository -o ./portfolio_item_repository_mock_test.go -n PortfolioItemRepositoryMock

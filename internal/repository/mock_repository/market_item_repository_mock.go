...
//go:generate minimock -i github.com/abrbird/portfolio_bot/internal/repository.MarketItemRepository -o ./market_item_repository_mock_test.go -n MarketItemRepositoryMock

...
//go:generate minimock -i gitlab.ozon.dev/zBlur/homework-2/internal/repository.CurrencyRepository -o ./currency_repository_mock_test.go -n CurrencyRepositoryMock

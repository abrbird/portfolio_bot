...
//go:generate minimock -i github.com/abrbird/portfolio_bot/internal/repository.PortfolioRepository -o ./portfolio_repository_mock_test.go -n PortfolioRepositoryMock

...
type UserService interface {
	...
	Create(user *domain.User, repo repository.UserRepository) error
	Retrieve(userId domain.UserId, repo repository.UserRepository) domain.UserRetrieve
	RetrieveOrCreate(user *domain.User, repo repository.UserRepository) domain.UserRetrieve
	Update(user *domain.User, repo repository.UserRepository) error
	Delete(userId domain.UserId, repo repository.UserRepository) error
}
